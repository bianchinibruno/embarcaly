...
| **RN.010.08** | Cada direito mostra o artigo | É o que separa informação de opinião, e é o que protege juridicamente | **Dado que** um direito é exibido,<br>**Quando** a pessoa o lê,<br>**Então** vê o `fonte` do registro — "Res. 400, art. 27, I" — junto ao texto |
